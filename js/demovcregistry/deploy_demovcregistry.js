...
const PATH_TO_CONTRACT = './target/wasm32-unknown-unknown/release/demovcregistry.wasm';
const { CONTRACT_DEMOVCREGISTRY_NAME, 
        DEPLOY_NODE_ADDRESS,
        DEPLOY_CHAIN_NAME,
        DEPLOYMENT_DEMOVCREGISTRY_KEY_PUBLIC_PATH,
        DEPLOYMENT_DEMOVCREGISTRY_KEY_SECRET_PATH
    } = require("../constants");
const { sleep } = require('sleep');
const DEPLOY_GAS_PRICE = 1;
const DEPLOY_GAS_PAYMENT = 50_000_000_000; //10000000000 = 10**10 ?= 1 CSPR ?
